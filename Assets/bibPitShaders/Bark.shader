Shader "BibPit/TreeBark"
{
    ...
    #include "Assets/Shaders/Chunks/BibPit.cginc"
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            c *= tex2D(_ColorMap, IN.life * .1 + nID );
          //  o.Albedo = c.rgb *  lerp(_BaseColorMultiplier, _TipColorMultiplier, IN.life);
            ...
            o.Emission =  c * sampleAudio(IN.life + length(tMap) *.03 , nID);//tex2Dlod(_AudioMap, float4(IN.life, _Timeline, 0,0));//sampleAudio(IN.life);//;
