...
namespace IMMATERIA
{
    public class ClothVerts : Form
    {
        ...
        public float topWidthMultiplier = 1;
        public float bottomWidthMultiplier = 1;
        ...
        public override void Embody()
        {
            ...
            for (int i = 0; i < numVertsX; i++)
            {
                for (int j = 0; j < numVertsY; j++)
                {
                    ...
                    v2 = new Vector3((x - .5f) * width * Mathf.Lerp(topWidthMultiplier, bottomWidthMultiplier, y), 0, (y - .5f) * height);
                    ...
                    values[id * structSize + 14] = -1;
                    values[id * structSize + 15] = 0;
