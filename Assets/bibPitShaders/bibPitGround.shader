...
float up =  dot( -v.normal, float3(0,1,0));
  o.Emission = tex2D(_ColorMap,v.texcoordBase.y * .5 + up * .5)* sampleAudio(v.texcoordBase.y * .5 +up* 1);// * 1* pow( up,1);//nor * .5 + .5;
